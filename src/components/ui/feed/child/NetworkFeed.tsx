...
import { useGetFeedPostsQuery } from "@/hooks/api/post/useGetFeedPostsQuery";
import { useEffect, useMemo, useRef } from "react";
import Post from "./Post";
import ErrorMessage from "../../error/ErrorMessage";

export default function NetworkFeed() {
    const { data, fetchNextPage, isFetchingNextPage, hasNextPage, error, isLoading } = useGetFeedPostsQuery();
